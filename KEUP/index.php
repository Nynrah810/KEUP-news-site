			...
			<?php
				for ($i = 0; $i < count($news); $i++) {
					...
					if ($i == 0)
						...
						if ($i / 2 != 1)
							echo "<div id=\"smallArticle\" class=\"left\">";
						else
							echo "<div id=\"smallArticle\" class=\"right\">";
					echo '<img src="images/articles/'.$news[$i]["id"].'.png"><h2>'.$news[$i]["name"].'</h2><p>'.$news[$i]["preview"].'</p><p class="date">'.$news[$i]["date"].'</p><a href="article.php?id='.$news[$i]["id"].'">Читать</a></div>';
				}
			?>
		</div>
	</section>
